...
{
public:
	enum Type { PING, SETPOINT, POSITION, TAKEOFF, LAND, SET_PARAM, GET_PARAM_INFO, GET_PARAM_VALUE, REQUEST_PARAM_TOC, RESET_LOGS, ADD_LOG_BLOCK, START_LOG, STOP_LOG, REQUEST_LOG_TOC, GET_LOG_ITEM_INFO, ACTIVATE_SAFELINK, STOP, REBOOT_INIT, REBOOT_FIRMWARE, LPS_NODE_POS_SET, LIGHTHOUSE_BS_GEOMETRY_SET, GET_MEMORY_NUMBER, GET_MEMORY_INFO, READ_MEMORY, WRITE_MEMORY, TYPES_MAX};
	const String typeStrings[TYPES_MAX] { "Ping","SetPoint","Position","TakeOff", "Land", "SetParam","GetParamInfo","GetParamValue","RequestParamToc","ResetLogs","AddLogBlock", "StartLog", "StopLog", "RequestLogToc", "GetLogItemInfo", "SafeLink", "Stop","RebootInit","RebootFirmware", "LPSNodePosSet", "LightHouseBSGeometrySet", "GetMemoryNumber","GetMemoryInfo","ReadMemory","WriteMemory" };
